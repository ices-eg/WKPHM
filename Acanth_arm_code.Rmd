...
```{r figure1, fig.cap="Locations of presence and absence observations for *Acanthogorgia armata* from the ICES database", echo=FALSE}
...
The four explanatory variables were examined for collinearity using a pearson correlations. 
