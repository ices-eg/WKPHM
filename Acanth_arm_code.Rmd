...
```{r table1, fig.cap="Table 1. Variance inflation factors for independent variables using in modeling.",echo=FALSE}
...
The results of the sequential variable reduction was the removal of the depth variable. Slope, TPI and Oxygen (and the polynomials for these variables) were all signficant. 
...
### Model predictions
```{r simplemodelpredictions,message=FALSE,warning=FALSE, cache=TRUE}
...
```{r simplemodelvalidation,message=FALSE,warning=FALSE, cache=TRUE}
...
```{r mapmodeluncertainty,message=FALSE,warning=FALSE, cache=TRUE}
##################################################################
